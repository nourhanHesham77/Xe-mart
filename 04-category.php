        ...
        <section class="category">
            <div class="container">
                <div class="row">
                  ...
                  $select_product=$connect->query("SELECT * FROM products WHERE cat_id='$id' LIMIT ".$offset.",".$item_per);

                                    }else{
                                        $select_product=$connect->query("SELECT * FROM products LIMIT ".$offset.",".$item_per);
                                    }
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="tab-item">
                                                <div class="tab-img">
                                                    <img class="main-img img-fluid" style="width:250px;height:260px;" src="admin/imges/<?php echo$img[0]?>" alt="">
                                                    <img class="sec-img img-fluid" style="width:250px;height:260px;" src="admin/imges/<?php echo$img[1]?>" alt="">
                                                    <div class="layer-box">
                            ...
                            <div class="pagination-box text-center">
                                <ul class="list-unstyled list-inline">
                                    ...
                                    $select = $connect->query("SELECT * FROM products WHERE cat_id = '$id'");
                                    ...
                                    ?>
                                    <li class="list-inline-item"><a href="04-category.php?page=<?php echo$page;
                                   if(isset($_GET['id'])){ echo'&id='.$id;} ?>"><?php echo$page?></a></li>
                                    <?php } ?>

                ...
                <div class="row">
                    <div class="col-lg-9 col-md-8">
                        <div class="blog-d-box">
                            <?php
                            $id=$_GET['id'];
                            $select_post=$connect->query("SELECT * FROM post WHERE id='$id'");
                            $row_post=$select_post->fetch_assoc();
                            ?>
                            <div class="image-box">
                                <img src="admin/imges/<?php echo$row_post['img'];?>" alt="" class="img-fluid">
                            </div>
                            <div class="image-content">
                                <h4><?php echo$row_post['headline']?></h4>
                                <ul class="list-unstyled list-inline">
                                ...
                                <p><?php echo$row_post['post'];?>
                                <span><?php echo$row_post['note']?></span>

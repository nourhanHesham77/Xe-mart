...
<!-- Mirrored from www.thetahmid.com/themes/xemart-v1.0/15-track-order.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jan 2022 22:15:46 GMT -->
<head>
        <meta charset="utf-8">
                    ...
                    <div class="col-md-12">
                        <div class="breadcrumb-box text-center">
                            <ul class="list-unstyled list-inline">
                                ...
                                <li class="list-inline-item"><span>||</span> Track Order</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <form action="#">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="order id" placeholder="Enter your order number">
                                    </div>
                                    <div class="col-md-12">
                                        <label>Confirm Your Email</label>
                                        <input type="text" name="email" placeholder="Enter your order email address">
                                    </div>
                                    <div class="col-md-12">
                                        <button type="button" name="button">Track Order</button>
                                    </div>
                                </div>
                            </form>
                        </div>

...
<!-- Mirrored from www.thetahmid.com/themes/xemart-v1.0/09-register.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jan 2022 22:15:46 GMT -->
<head>
        <meta charset="utf-8">
                        ...
                        <form id="myform">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="f-name"id="fname" placeholder="Your first name">
                                </div>
                                <div class="col-md-12">
                                    <label>Last Name*</label>
                                    <input type="text" name="l-name" id="lname" placeholder="Your Last name">
                                </div>
                                <div class="col-md-12">
                                    <label>Email Address*</label>
                                    <input type="text" name="mail" id="mail" placeholder="Your email address">
                                </div>
                                <div class="col-md-12">
                                    <label>Phone Number*</label>
                                    <input type="text" name="phn" id="phn" placeholder="Your phone number">
                                </div>
                                <div class="col-md-12">
                                    <label>Password*</label>
                                    <input type="text" name="pas" id="pas" placeholder="Password should be more than 6 character">
                                </div>
                                <div class="col-md-12">
                                    <label>Confirm Password*</label>  <p id="firm-pass"></p>
                                    <input type="text" name="c-pas" id="cpas" placeholder="Confirm your password">
                                </div>
                                <div class="col-md-7">
                                    <div>
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#myform").submit(function(e){
                    ...
                    if(!fname){
                        $("#fname").attr("placeholder","Please enter ur first name").addClass("alert2");
                    }
                    if(!lname){
                        $("#lname").attr("placeholder","Please enter ur last name").addClass("alert2");
                    }
                    if(!mail){
                        $("#mail").attr("placeholder","Please enter ur  email").addClass("alert2");
                    }
                    if(!phone){
                        $("#phn").attr("placeholder","Please enter ur phone ").addClass("alert2");
                    }
                    if(!password){
                        $("#pas").attr("placeholder","Please enter ur password").addClass("alert2");
                    }
                    if(cpass != password){
                        $("#firm-pass").html("confirm password doesn't match").addClass("alert");
                    }
                    else{
                         $("#firm-pass").empty(); 
                     }
                    ...
                    if(fname&&lname&&mail&&phone&&password&&cpass==password){
                        $.post("functions/add_customer.php",{
                          sfname:fname,
                          slname:lname,
                          smail:mail,
                          sphone:phone,

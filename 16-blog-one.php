...
<!-- Mirrored from www.thetahmid.com/themes/xemart-v1.0/16-blog-one.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jan 2022 22:15:46 GMT -->
<head>
        <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row">
                    ...
                    if(isset($_GET['page'])){
                        $pag=$_GET['page'];
                        $item_per=3;
                        $offset=($pag-1)*$item_per;

                        $select_post=$connect->query("SELECT * FROM post LIMIT ".$offset.",".$item_per);
                    }else{
                        $pag=1;
                        $item_per=3;
                        $offset=($pag-1)*$item_per;
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-box">
                            <div class="blog-img">
                                <a href="19-blog-details.php?id=<?php echo$row_post['id'];?>"><img src="admin/imges/<?php echo$row_post['img']; ?>" alt="" class="img-fluid"></a>
                            </div>
                            <div class="blog-content">
                                <h5><a href="19-blog-details.php?id=<?php echo$row_post['id'];?>"><?php echo$row_post['headline']?></a></h5>
                                <ul class="list-unstyled list-inline">
                                    <li class="list-inline-item"><i class="fa fa-user-o"></i><a href=""><?php echo$row_post['name']?></a></li>
                                    <li class="list-inline-item"><i class="fa fa-calendar"></i><?php echo$row_post['date']?></li>
                                </ul>
                                <p><?php echo$row_post['note']?></p>
                            </div>
                        </div>
        			</div>
                    <?php } ?>
                    <div class="col-md-12">
                        <div class="pagination-box text-center">
                            <ul class="list-unstyled list-inline">
                                <?php $get_post=$connect->query("SELECT * FROM post");
                                $number=$get_post->num_rows;
                                $pagepernumber=3;
                                $pages = ceil($number/$pagepernumber);
                                for($page=1;$page<=$pages;$page++){
                                ?>
                                <li class="list-inline-item"><a href="16-blog-one.php?page=<?php echo$page; ?>"><?php echo$page?></a></li>
                                <?php } ?>
...
<!-- Mirrored from www.thetahmid.com/themes/xemart-v1.0/16-blog-one.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jan 2022 22:15:48 GMT -->
</html>

...
setcookie('visit','traffic',time()+60*60,'/');
$update_count = $connect -> query("UPDATE traffic SET count = count +1");
}
?>
...
<!-- Mirrored from www.thetahmid.com/themes/xemart-v1.0/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jan 2022 22:15:32 GMT -->
<head>
        <meta charset="utf-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 padding-fix">
                        <form action="search.php" method="get" class="search-bar">
                            <input type="text" name="search-bar" class="src-in" placeholder="I'm looking for...">
                    ...
                    <div class="col-md-4">
                        <div class="carts-area d-flex">
                            ...
                            <div class="cart-box ml-auto text-center" >
                                <a href="<?php if(!isset($_SESSION['login'])){echo'08-login.php';}?>" class="<?php if(isset($_SESSION['login'])){echo'cart-btn';}?>">
  ...
  $getall=0;
          ...
          ?>
               ...
               <div class="aja<?php echo $row_cart['id'] ?>" >
                    <div class="content-item d-flex justify-content-between">
                        <div class="cart-img">
                            <a href="#"><img src="admin/imges/<?php echo$img[0]?>" alt="" style="width:45px;height:50px;"></a>
                        </div>
                        <div class="cart-disc">
                        ...
                        <div class="delete-btn">
                            <a><i class="fa fa-trash-o remov" onclick="deleteAjax(<?php echo$row_cart['id'];?>)" carid="<?php echo$row_cart['id']?>"></i></a>
                        </div>
                    </div>
      ...
      <hr>
                ...
                <?php } ?>
                   ...
                   <div class="cart-btm">
                    <p class="text-right">Sub Total: <span><?php 
                //    echo$getall; ?></span></p>
                    <a href="06-shopping-cart.php" >Checkout</a>
                </div>
                    ...
                    <div class="col-lg-6 col-md-7">
                        <div class="main-menu">
                            <ul class="list-unstyled list-inline">
                                ...
                                <li class="list-inline-item"><a>page <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown list-unstyled">
                                        <li><a href="03-about-us.php">About Us</a></li>
                                        <li><a href="04-category.php?do=all&page=1">Category</a></li>
                        ...
                        <div class="main-menu">
                            <ul class="list-unstyled list-inline">
                                ...
                                <li class="list-inline-item"><a>PAGES <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown list-unstyled">
                                        <li><a href="03-about-us.php">About Us</a></li>
                                        <li><a href="04-category.php?page=1">Category</a></li>
                                        <li><a href="05-single-product.php">Single Product</a></li>
                                        <li><a href="06-shopping-cart.php">Shopping Cart</a></li>
                                        <li><a href="07-checkout.php">Checkout</a></li>
                                        <li><a href="08-login.php">Log In</a></li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-0">
                        <div class="menu-widget">
                            ...
                            <ul class="list-unstyled">
                            <li><a href="#"><img src="images/sm.png" alt="">All Products</a></li>
                                <?php
                                ...
                                ?>
                                <li><a href="04-category.php?id=<?php echo$row_category['id']?>&page=1"><img src="images/sm.png" alt=""><?php echo$row_category['name']?></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
                                            ...
                                            <?php 
                                                ...
                                                <div class="tab-item">
                                                    ...
                                                    <div class="img-content d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                            <a style="cursor:pointer;" car-data="<?php echo$row_product['id']?>" data-toggle="tooltip" class="goCart" data-placement="top" title="Add to Cart" ><img src="images/it-cart.png" alt=""></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php }?>
                            ...
                            <div class="col-md-12 padding-fix-l20">
                                <div class="new-product">
                                    ...
                                    <div class="new-slider owl-carousel">
                                             <?php 
                                                $insert_product=$connect->query("SELECT * FROM products ORDER BY id DESC");
                                                foreach($insert_product as $row_product){
                                                    $img=explode(",",$row_product['img']);
                                        ...
                                        <div class="new-item">
                                            ...
                                            <div class="img-content d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <a style="cursor:pointer;" data-toggle="tooltip" car-data="<?php echo$row_product['id']?>" data-placement="top" class="goCart" title="Add to Cart"><img src="images/it-cart.png" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
...
$(".count-cart").html(data); 
            ...
            $(document).ready(function(){
                ...
                $(".goCart").click(function(){
                    var product=$(this).attr("car-data");

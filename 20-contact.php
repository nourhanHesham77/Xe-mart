...
<!-- Mirrored from www.thetahmid.com/themes/xemart-v1.0/20-contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jan 2022 22:15:50 GMT -->
<head>
        <meta charset="utf-8">
                        ...
                        $(document).ready(function(){
                            ...
                            $("#myform").submit(function(e){
                                ...
                                if(!name){
                                    ...
                                    $("#name").attr("placeholder","please enter your name").addClass("alert");
  
                                }if(!email){
                                    $("#email").attr("placeholder","please enter your email").addClass("alert");
                                }
                                if(!subject){
                                    $("#subject").attr("placeholder","please enter your subject").addClass("alert");
                                }
                                if(!message){
                                    $("#message").attr("placeholder","please enter your message").addClass("alert");
                                }
                                ...
                                if(name&&email&&subject&&message){
                                    $.post("functions/add_comment.php",{
                                        sname:name,
                                        semail:email,
                                        ssubject:subject,
                                        smessage:message
...
<!-- Mirrored from www.thetahmid.com/themes/xemart-v1.0/20-contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jan 2022 22:15:51 GMT -->
</html>
